...
export default function SeoTextPage() {
    ...
    if (pathname === "/team") {
        return (
            <>
                <p>Capobrain is a comprehensive school management software designed to streamline educational processes and enhance overall school operations. Our platform brings together students, teachers, parents, and administrators on a single interface, making it easier to manage academic and administrative tasks effectively.</p>
                <p>With Capobrain, managing school operations has never been easier. Our software automates various tasks such as attendance tracking, timetable management, and grade reporting, helping schools save time and reduce errors. This allows educators to focus on what truly matters—providing quality education.</p>
                <p>Capobrain’s built-in communication tools create a seamless connection between schools and their communities. Whether it’s sharing updates with parents, scheduling parent-teacher meetings, or addressing student concerns, Capobrain ensures clear and efficient communication across all levels.</p>
                <p>No two schools are the same, and Capobrain recognizes that. Our customizable features allow schools to choose the modules that best fit their needs, whether it’s managing extracurricular activities, overseeing school finances, or tracking student progress. With Capobrain, you can create a solution that’s perfect for your institution.</p>
                <p>Capobrain is a comprehensive school management software designed to simplify administrative tasks and enhance communication across your institution. Whether you’re a teacher, administrator, or parent, Capobrain makes managing school operations easier and more efficient, allowing you to focus on what truly matters—education.</p>
                <p>Say goodbye to the hassle of managing student records manually. With Capobrain, you can organize and access student information in one central platform. From enrollment details to academic performance, everything is just a click away, ensuring that you have all the data you need at your fingertips.</p>
                <p>Capobrain is designed to integrate smoothly with existing systems, ensuring a hassle-free transition for your school. Our dedicated support team is here to assist you every step of the way, providing training and resources to help you maximize the benefits of our software. With Capobrain, you’re not just getting a product; you’re gaining a partner committed to your school's success.</p>
            </>
        )
    }
    if (pathname === "/blog") {
